...
public class DragContext
{
	...
	public DragContext copy()
	{
		DragContext dragContext = new DragContext();
		dragContext.setMouseAnchorX(mouseAnchorX);
		dragContext.setMouseAnchorY(mouseAnchorY);
		dragContext.setTranslateAnchorX(translateAnchorX);
		dragContext.setTranslateAnchorY(translateAnchorY);
